...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("1", new Composer("1", "Hlompho Sebastian", "Bach", "Baroque"));
        composers.put("2", new Composer("2", "Hlompa", "Corelli", "Baroque"));
        composers.put("3", new Composer("3", "Hlomelang Frideric", "Handel", "Baroque"));
        composers.put("4", new Composer("4", "Hloma", "Purcell", "Baroque"));
        composers.put("5", new Composer("5", "Hloho", "Rameau", "Baroque"));
